...
Los datos que se muestran en este proyecto deben leerse como **tendencias dentro de una muestra concreta**, no como conclusiones generales sobre toda la población.

Las diferencias entre grupos representan **patrones agregados**, es decir, comportamientos medios de conjunto.  
No indican relaciones de causa-efecto ni permiten realizar diagnósticos individuales.

Este enfoque respeta la complejidad del bienestar digital y evita simplificaciones excesivas en un contexto claramente **multifactorial**, donde influyen múltiples variables personales y sociales.
...
Este apartado resume los principales patrones observados en el dashboard desde un enfoque de **estadística descriptiva**, limitándose a lo que los datos permiten afirmar.

### Bloque 1 · Tiempo de pantalla y distribución del uso

La distribución del uso no es homogénea: el grupo de **alto uso** concentra la mayor parte de las horas de pantalla, aunque no incluye a todas las personas de la muestra. La lectura conjunta de **porcentaje de usuarios** y **porcentaje de horas** permite distinguir entre tamaño del grupo y carga real de uso. Al segmentar por edad o modalidad laboral, aparecen perfiles donde ambas proporciones aumentan simultáneamente, señalando colectivos más expuestos a un uso intensivo sin implicar efectos directos sobre el estrés.

### Bloque 2 · Horas de sueño y calidad del descanso

La muestra presenta un claro desequilibrio entre buen y mal descanso, algo relevante al interpretar medias. Aun así, el patrón es consistente: quienes reportan **mejor descanso** duermen más horas y muestran **menores niveles medios de estrés**. La diferencia entre grupos es más evidente en estrés que en horas dormidas, lo que sugiere que la calidad del descanso refleja factores adicionales a la duración del sueño.

### Bloque 3 · Productividad percibida según modo de trabajo

El trabajo **remoto** registra las mayores medias de horas de pantalla, pero este aumento no se traduce en un incremento proporcional de la productividad percibida. La comparación entre remoto, híbrido y presencial muestra grandes diferencias en uso de pantallas y variaciones más moderadas en productividad, apuntando a una relación débil entre ambas variables en esta muestra. El dashboard funciona aquí como una comparación de medias segmentadas, sin necesidad de modelos explicativos.

### Bloque 4 · Horas sociales y bienestar general

El uso de pantallas por edad es claramente asimétrico: los grupos de **25–34** y **35–44** concentran la mayor parte de las horas totales. Al cruzar promedios de uso y bienestar, no emerge una relación única del tipo “más pantalla, peor bienestar” en todos los grupos. Algunos segmentos con alto uso mantienen niveles de bienestar similares a otros con menor exposición, lo que refuerza una lectura **multifactorial** que integra sueño y socialización. Cada visualización representa medias de grupo, no comportamientos individuales.
